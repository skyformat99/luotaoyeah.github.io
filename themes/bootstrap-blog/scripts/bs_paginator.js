...
function bsPaginatorHelper(options) {
  ...
  var currentPage =
    '<li class="active"><span class="page-number">' +
  ...
  if (prevNext) {
    if (current > 1) {
      ...
      result +=
        '<li class="disabled"><span class="page-prev">' +
        prevText +
        "</a></li>";
    }
  }
  ...
  if (options.show_all) {
    ...
    var leftMid =
      current - midSize <= endSize
        ? current - midSize + endSize
        : current - midSize;
    var rightMid =
      current + midSize + endSize > total
        ? current + midSize - endSize
        : current + midSize;
    var spaceHtml =
      '<li class="disabled"><span class="page-space">' + space + "</span></li>";
  ...
  if (prevNext) {
    if (current < total) {
      ...
      result +=
        '<li class="disabled"><span class="page-next">' +
        nextText +
        "</a></li>";
    }
  }
